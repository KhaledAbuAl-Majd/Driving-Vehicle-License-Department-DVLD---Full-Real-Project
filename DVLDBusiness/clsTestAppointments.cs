...
namespace DVLDBusiness
{
    public class clsTestAppointments
    {
        ...
        public float TotalPaidFees { get; private set; }
        public int CreatedByUserID { get; set; }
        public bool IsLocked { get; private set; }
        public short TrialNumber { get; private set; }
        public float TestFees { get; private set; }
        public float RetakeTestFees{ get; private set; }

        public clsTestAppointments(int LocalDrivingLicenseApplicationID, int TestTypeID)
        {
            ...
            this.TestFees = clsTestTypes.FindTestType(this.TestTypeID).TestFees;
            ...
            DateTime AppointmentDate, float PaidFees, int CreatedByUserID, bool IsLocked,short TrialNumber)
        {
            ...
            _SetTestMode();
            _SetRetakeTestFees();
            this.TestFees = this.TotalPaidFees - this.RetakeTestFees;
        }

        void _SetTotalPaidFees()
        {
            this.TotalPaidFees = this.TestFees + this.RetakeTestFees;
        }
        void _SetTestMode()
        {
            TestMode = (this.TrialNumber == 0) ? enTestMode.FirstTest : enTestMode.RetakeTest;
        }
        void _SetRetakeTestFees()
        {
            RetakeTestFees = (TestMode == enTestMode.FirstTest) ? 0 : 5;
        }
        ...
        bool _AddNewTestAppointment()
        {
            ...
            TestAppointmentID = clsTestAppointmentsData.AddNewTestAppointment(TestTypeID, LocalDrivingLicenseApplicationID,
                AppointmentDate, TotalPaidFees, CreatedByUserID, IsLocked, TrialNumber);
        ...
        public static clsTestAppointments Find(int TestAppointmentID)
        {
            ...
            if (clsTestAppointmentsData.GetTestAppointmentInfoByTestAppointmentID(TestAppointmentID, ref TestTypeID, ref LocalDrivingLicenseApplicationID
                , ref AppointmentDate, ref TotalPaidFees, ref CreatedByUserID, ref IsLocked, ref TrialNumber))
