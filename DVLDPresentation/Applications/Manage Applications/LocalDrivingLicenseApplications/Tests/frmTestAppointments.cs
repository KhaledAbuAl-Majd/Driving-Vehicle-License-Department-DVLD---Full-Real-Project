...
namespace DVLDPresentation.Applications.Manage_Applications.Schedule_Test
{
    public partial class frmTestAppointments : Form
    {
        ...
        public frmTestAppointments(int LDLApplicationID,byte PassedTestsNum)
        {
            InitializeComponent();
        ...
        private void btnAddAppointment_Click(object sender, EventArgs e)
        {
            ...
            frmScheduleTestAdd_Edit frm = new frmScheduleTestAdd_Edit(_LDLApplicationID, -1,Convert.ToInt32(_TestType));
        ...
        {
            frmScheduleTestAdd_Edit frm = new frmScheduleTestAdd_Edit(_LDLApplicationID,
